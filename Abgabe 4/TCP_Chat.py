...
def server(port):
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as my_server_sock:
        ...
        while True:
            ...
            user_input = input("Befehl eingeben ('send hello', 'send to', 'my address', 'my contacts', 'broadcast', 'stop'): ").strip()
...
if __name__ == '__main__':
    ...
    username = ""
    commands = ["send to", "send hello", "my address", "my contacts", "broadcast"]
    contacts = {}
    start()
